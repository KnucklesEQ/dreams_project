...
final class SonologTestFixtures {

    record DreamItemFixture(
        String dreamId,
    ...
    static Path createAppHome(Path rootDirectory) throws IOException {
    ...
    static Path writeValidConfig(Path appHome) throws IOException {
        return writeConfig(appHome, validConfigJson(appHome));
    }

    static Path writeConfig(Path appHome, String configJson) throws IOException {
        Files.createDirectories(appHome.resolve("config"));
    ...
    static String validConfigJson(Path appHome) {
    ...
    static DreamItemFixture createImportedDreamItem(Path appHome, String dreamId) throws IOException {
        return createDreamItem(appHome, dreamId, "imported", false, false, false, false);
    }

    static DreamItemFixture createTranscribedDreamItem(Path appHome, String dreamId) throws IOException {
        return createDreamItem(appHome, dreamId, "transcribed", true, false, false, false);
    }

    static DreamItemFixture createCleanedDreamItem(Path appHome, String dreamId) throws IOException {
        return createDreamItem(appHome, dreamId, "cleaned", true, true, false, false);
    }

    static DreamItemFixture createAnalyzedDreamItem(Path appHome, String dreamId) throws IOException {
        return createDreamItem(appHome, dreamId, "analyzed", true, true, true, false);
    }

    static DreamItemFixture createCompletedDreamItem(Path appHome, String dreamId) throws IOException {
