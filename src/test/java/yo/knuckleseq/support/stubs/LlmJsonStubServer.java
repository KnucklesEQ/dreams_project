package yo.knuckleseq.support.stubs;
...
public final class LlmJsonStubServer implements AutoCloseable {
    ...
    public static LlmJsonStubServer start(int statusCode, String responseText) throws IOException {
    ...
    public static String successfulCleanupJson(String dreamId) {
        return """
            {
              "schemaVersion": 1,
              "dreamId": "%s",
    ...
    public static String cleanupJsonWithUnknownKey(String dreamId) {
    ...
    public static String cleanupJsonWithHallucination(String dreamId) {
        return successfulCleanupJson(dreamId).replace(
    ...
    public static String successfulAnalysisJson(String dreamId) {
        return """
            {
              "schemaVersion": 1,
              "dreamId": "%s",
