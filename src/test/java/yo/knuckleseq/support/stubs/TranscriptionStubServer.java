...
public final class TranscriptionStubServer implements AutoCloseable {
    ...
    public static TranscriptionStubServer start(int statusCode, String responseBody) throws IOException {
    ...
    public static String successfulVerboseJsonResponse() {
        return """
            {
    ...
    public static String emptyVerboseJsonResponse() {
        return """
            {
              "text": "",
              "language": "es",
