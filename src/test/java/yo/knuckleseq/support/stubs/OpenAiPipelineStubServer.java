...
public final class OpenAiPipelineStubServer implements AutoCloseable {

    public static record StubResponse(int statusCode, String responseText) {
    }
    ...
    public static OpenAiPipelineStubServer start(StubResponse transcriptionResponse, StubResponse... llmResponses) throws IOException {
